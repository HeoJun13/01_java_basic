...
public class OperatorEx03_풀이 {
	...
	public static void main(String[] args) {
		...
		System.out.println("세금 = " + (double)2000000 * (double)3.3 + "입니다");
		
		
		//문제2) 시험점수를 100, 88, 92점 을 받았다. 평균은?
				System.out.println("평균은 " + (100+88+92)/3 + "점 입니다.");
		
		//문제3) 밑변이 3이고 높이가 7인 삼각형 넓이 출력 (삼각형의 넓이 구하는 공식 : 밑변 * 높이 / 2)
				System.out.println("삼각형 넓이는 " + (3*7)/(double)2 + " 입니다");
