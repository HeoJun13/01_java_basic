...
public class PrintEx03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1)로그인\t2)로그아웃\t3)공지사항"); // tap 라인
		 ...
		 */
		Date time1 = new Date();
		System.out.println(time1); //Wed May 10 15:45:53 KST 2023
		
		long time2 = System.currentTimeMillis();
		System.out.println(time2); //1683701153485
		System.out.println();
