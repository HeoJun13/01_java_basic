...
//2) 주석 (comment) : 설명문을 작성하기 위한 방법 으로 프로그램의 실행에 영양을 미치지 않는다
...
public class PrintEx01 {
	...
	public static void main(String[] args) {
		...
		// tab으로 들여쓰기한 이루에 코드를 작성한다.
		
		
		// System.out.println(데이터); 1)데이터를 화면에 출력한다, 20 줄을 바꾼다.(개행),new line)
		System.out.println("==========");
		...
		// System.out.print(데이터); 1)데이터를 화면에 출력한다, 20 줄을 바꾼다.(개행),new line)
